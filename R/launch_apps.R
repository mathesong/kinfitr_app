#' Launch kinfitr Apps
#'
#' @description Launch a specified kinfitr application
#'
...
#'
#' @details
#' This function provides a unified interface to launch kinfitr applications:
...
#'
#' Parameter usage:
#' - regiondef: Uses bids_dir, derivatives_dir, kinfitr_output_foldername
