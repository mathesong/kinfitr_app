#' Run kinfitr Modelling App for Reference Tissue Models
#'
#' @description Launch the kinfitr modelling configuration interface for setting up reference tissue kinetic models
#'
...
modelling_ref_app <- function(bids_dir = NULL, derivatives_dir = NULL, blood_dir = NULL, subfolder = "Primary_Analysis", config_file = NULL) {
  ...
  ui <- fluidPage(theme = shinythemes::shinytheme("flatly"),
    ...
    # App title ----
    titlePanel("kinfitr Modelling App for Reference Tissue Models"),
