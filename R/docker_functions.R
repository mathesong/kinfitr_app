...
#'
#' @param config List containing kinfitr configuration
...
#'
#' @description Execute the kinfitr analysis pipeline automatically based on config file
#'
...
#'
#' @description Execute a single step of the kinfitr pipeline
#'
