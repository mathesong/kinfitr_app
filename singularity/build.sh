...
# Singularity build script for kinfitr app
...
show_help() {
    cat << EOF
Build script for kinfitr Singularity container
...
echo "=== kinfitr Singularity Build ==="
echo "Project root: $PROJECT_ROOT"
echo "Definition file: $BUILD_DIR/kinfitr.def"
echo "Output: $OUTPUT"
...
echo "Command: $BUILD_CMD $BUILD_ARGS $OUTPUT $BUILD_DIR/kinfitr.def"
echo

$BUILD_CMD $BUILD_ARGS "$OUTPUT" "$BUILD_DIR/kinfitr.def"
