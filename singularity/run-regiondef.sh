...
# Singularity run script for kinfitr region definition app
...
show_help() {
    cat << EOF
Run kinfitr region definition app in Singularity container
...
Examples:
    ...
    $0 --container ./kinfitr_dev.sif --bids-dir /path/to/bids --kinfitr-folder custom_kinfitr
...
The region definition app creates:
    - kinfitr_regions.tsv file in code/kinfitr/ folder
    - Combined TACs files in derivatives/kinfitr/ folder
...
echo "=== kinfitr Region Definition App ==="
